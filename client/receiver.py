...
def main(address, port, protocol, zmq_ip, zmq_port):
    ...
    for res in receive(category_index, detection_model, address, port, protocol):
...
if __name__ == "__main__":
    ...
    print('ASDASD')
    #main(conf['Video']['IP'], conf['Video']['Port'], conf['Video']['Protocl'],s
